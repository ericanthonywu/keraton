...
{{--            <div class="modal fade" id="editshowphoto" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">--}}
                        ...
                        <form class="m-form m-form--state m-form--fit m-form--label-align-right" data-action="unit" novalidate="novalidate">
                            ...
                            <div class="m-portlet__body">
                                ...
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                        <input type="text" class="form-control m-input" name="nama" placeholder="Masukkan Nama Unit" value="{{$data['nama']}}" required>
...
{{--                                    <div class="col-lg-9 col-md-9 col-sm-12">--}}
{{--                                        <button type="button" class="btn btn-circle btn-primary btn-outline-primary btn-show-photo btn-xs btn-data" data-original-title="Show Photo" data-toggle="modal" data-target="#editshowphoto" data-id="{{$data['id']}}"><i class="flaticon-photo-camera"></i> </button>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
                                <div class="form-group m-form__group row">
                                        ...
                                        <div class="input-group-prepend">
                                            <select name="lokasi_fix" class="form-control" id="lokasi_fix">
                                                ...
                                                @foreach($lokasi as $datalokasi)
                                                    <option value="{{$datalokasi['id']}}" {{$data['lokasi_fix'] == $datalokasi['id'] ? "selected" : ""}}>{{$datalokasi['lokasi']}}</option>
                                                @endforeach
                                            </select>
                                            <input type="text" name="lokasi_text" class="form-control" placeholder="Masukkan Lokasinya" value="{{$data['lokasi_text']}}">
                                        </div>
                                ...
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control m-input number ribuan" data-id="harga" placeholder="Masukkan Harga Unit" value="{{number_format($data['harga'])}}">
                                        </div>
                                ...
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                        <textarea type="text" class="form-control autosizeme" id="deskripsi" name="description" placeholder="Masukkan Description Unit">{{$data['description']}}</textarea>
