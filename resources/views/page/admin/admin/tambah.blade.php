                            ...
                            <div class="m-portlet__body">
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                        <input type="text" class="form-control m-input" name="kategori_barang" placeholder="Masukkan Kategori Barang">
                                        <span class="m-form__help">Mohon Masukkan Kategori Barang</span>
                                    </div>
                                </div>
                                {{--<div class="form-group m-form__group row">--}}
