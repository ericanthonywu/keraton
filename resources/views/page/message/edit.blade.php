                        ...
                        <form class="m-form m-form--state m-form--fit m-form--label-align-right" data-action="message"
                            ...
                            <div class="m-portlet__body">
                                <div class="form-group m-form__group row">
                                    <label class="col-form-label col-lg-3 col-sm-12">Marketing yang dituju : </label>
                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                        <input type="text" class="form-control m-input" value="{{$marketing}}" readonly>
                                    </div>
                                </div>
                                <div class="form-group m-form__group row">
                                    <label class="col-form-label col-lg-3 col-sm-12">Judul Pesan</label>
                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                        <textarea type="text" class="form-control maxlength update_textarea" name="judul"
                                                  placeholder="Masukkan Judul" maxlength="50">{{$data['judul']}}</textarea>
                                ...
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                        <textarea type="text" class="form-control maxlength update_textarea" name="pesan"
                                                  placeholder="Masukkan Pesan" maxlength="160">{{$data['pesan']}}</textarea>
                                ...
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="m-checkbox-list">
                                        <label class="m-checkbox m-checkbox--solid m-checkbox--success">
                                            <input type="checkbox" disabled {{$data['push_notif'] ? "checked" : ""}}> Push Notifikasi
                                            <span></span>
                                        </label>
                                    </div>
                                </div>
