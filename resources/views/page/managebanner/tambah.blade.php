                                ...
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                        <input type="text" class="form-control m-input" name="nama"
                                               placeholder="Masukkan Nama Banner" required>
                                ...
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                        <input type="text" class="form-control m-input number" name="phone"
                                               placeholder="Masukkan No HP Banner">
                                ...
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="m-checkbox-list">
                                        <label class="m-checkbox m-checkbox--solid m-checkbox--success">
                                            <input type="checkbox" id="checkkonf"> Konfirmasi (Ya / Tidak)
                                            <span></span>
                                        </label>
                                        <span class="m-form__help">Mohon Tentukan Konfirmasi Banner</span>
                                    </div>
                                </div>
                                <div class="form-group m-form__group row" id="konf" style="display: none;">
                                    ...
                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                        <textarea class="form-control m-input" name="confirmation"
                                                  placeholder="Masukkan Isi Konfirmasi Banner"></textarea>
