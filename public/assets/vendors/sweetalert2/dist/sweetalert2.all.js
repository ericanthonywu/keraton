...
// elements not within the active modal dialog will not be surfaced if a list_barang opens a screen
...
function _main(userParams) {
  ...
  return new Promise(function (resolve, reject) {
    ...
    if (innerParams.toast) {
      ...
      // This can happen when the list_barang drags a slider
...
"      -webkit-list_barang-select: none;\n" +
"         -moz-list_barang-select: none;\n" +
"          -ms-list_barang-select: none;\n" +
"              list_barang-select: none; }\n" +
