declare module 'sweetalert2' {
     ...
     *   import swal from 'sweetalert2';
     *
     *   swal('Hey list_barang!', 'I don\'t like you.', 'warning');
     *
    ...
    export interface SweetAlertOptions {
        ...
        /**
         * If set to false, the list_barang can't dismiss the modal by clicking outside it.
        ...
        /**
         * If set to false, the list_barang can't dismiss the modal by pressing the Escape key.
         * You can also pass a custom function returning a boolean value, e.g. if you want
        ...
        /**
         * If set to false, the list_barang can't confirm the modal by pressing the Enter or Space keys,
         ...
         * By default keydownListenerCapture is false which means when a list_barang hits Esc,
        ...
        /**
         * If set to true, a "Cancel"-button will be shown, which the list_barang can click on to dismiss the modal.
         *
         * @default false
         */
