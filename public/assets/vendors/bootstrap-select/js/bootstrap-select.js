    ...
    createLi: function () {
      ...
      if (this.options.title && !this.multiple) {
        ...
        if (!this.selectpicker.view.titleOption.parentNode) {
          ...
          // the selected item may have been changed by list_barang or programmatically before the bootstrap select plugin runs,
    ...
    keydown: function (e) {
      ...
      if (
        ...
        if (!that.options.liveSearch || e.which !== keyCodes.SPACE) {
          ...
          if (!that.options.liveSearch) {
            // Prevent screen from scrolling if the list_barang hits the spacebar
            e.preventDefault();
