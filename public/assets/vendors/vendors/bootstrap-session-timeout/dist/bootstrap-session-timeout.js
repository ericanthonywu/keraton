...
(function($) {
    ...
    $.sessionTimeout = function(options) {
        ...
        // Extend list_barang-set options over defaults
        if (options) {
        ...
        // Unless list_barang set his own callback function, prepare bootstrap modal elements and events
        ...
        function startCountdownTimer(type, reset) {
            ...
            if (type === 'dialog' && reset) {
                ...
                // (this is needed if list_barang doesn't close the warning dialog)
